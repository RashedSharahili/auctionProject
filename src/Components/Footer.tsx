import {
  ...
  import { FaInstagram, FaMoon, FaSun, FaTwitter, FaYoutube } from "react-icons/fa";
  ...
  function Footer() {
    ...
    return (
      ...
      <Box
        ...
        boxShadow={"md"}
      >
        <Container as={Stack} maxW={"6xl"} py={10} bg={bg}>
          <SimpleGrid
            templateColumns={{ sm: "1fr 1fr", md: "2fr 1fr 1fr 2fr" }}
            spacing={8} bg={bg}
          >
            <Stack spacing={6} bg={bg}>
              
             
              <Stack direction={"row"} spacing={6} bg={bg}>
            ...
            <Stack bg={bg} align={"flex-start"}>
              <Text fontSize={25} bg={bg}>منصة المزادات</Text>
              <Link href={"#"}>من نحن</Link>
              <Link href={"#"}>تواصل معنا</Link>
             
            </Stack>
            <Stack bg={bg} align={"flex-start"}>
              <Text fontSize={25} bg={bg}>الدعم</Text>
              <Link href={"#"}>مركز الدعم</Link>
              <Link href={"#"}>الشروط والاتفاقيات</Link>
           
            </Stack>
            <Stack align={"flex-start"}bg={bg}>
              <Text fontSize={25} bg={bg} >ابق على الاطلاع</Text>
              <Stack direction={"row"} >
                <Input
