  ...
  const MobileNavContent = (
    ...
    >
      ...
      <Button w="full" variant="ghost">
        <RouteLink to={"/"}>الصفحة الرئيسية</RouteLink>
      </Button>
      <Button w="full" variant="ghost" leftIcon={<AiOutlineInbox />}>
        <RouteLink to={"/about"}>من نحن</RouteLink>
      </Button>
      <Button w="full" variant="ghost" leftIcon={<BsFillCameraVideoFill />}>
        <RouteLink to={"/auctions"}>المزادات</RouteLink>
      </Button>
      <Button w="full" variant="ghost" leftIcon={<BsFillCameraVideoFill />}>
        <RouteLink to={"/contact"}>تواصل معنا</RouteLink>
      </Button>
    </VStack>
  );
